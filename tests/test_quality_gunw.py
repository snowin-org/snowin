...
def test_build_gunw_quality_mask_reasons():
    ...
    out = build_gunw_quality_mask(phase, coherence=coherence, connected_components=cc, gunw_mask=mask, connected_component=1)
...
def test_build_gunw_quality_mask_dominant_component():
    ...
    out = build_gunw_quality_mask(phase, connected_components=cc, connected_component="dominant")
